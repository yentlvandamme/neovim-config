...
_G.packer_plugins = {
  ...
  ["cellular-automaton.nvim"] = {
    loaded = true,
    path = "/home/ubuntu/.local/share/nvim/site/pack/packer/start/cellular-automaton.nvim",
    url = "https://github.com/eandrju/cellular-automaton.nvim"
  },
  ["cloak.nvim"] = {
    loaded = true,
    path = "/home/ubuntu/.local/share/nvim/site/pack/packer/start/cloak.nvim",
  ...
  playground = {
    loaded = true,
    path = "/home/ubuntu/.local/share/nvim/site/pack/packer/start/playground",
  ...
  ["refactoring.nvim"] = {
    loaded = true,
    path = "/home/ubuntu/.local/share/nvim/site/pack/packer/start/refactoring.nvim",
